                ...
                <div class="cta-inner text-center rounded">
                    ...
                    <ul class="list-unstyled list-hours mb-5 text-left mx-auto">
                        <li class="list-unstyled-item list-hours-item d-flex">
                            Sunday
                            @if($store->sun_open == '00:00:00' && $store->sun_close == '00:00:00')
                        ...
                        <li class="list-unstyled-item list-hours-item d-flex">
                            Monday
                            @if($store->mon_open == '00:00:00' && $store->mon_close == '00:00:00')
                                <span class="ml-auto">Closed</span>
                            @else
                        ...
                        <li class="list-unstyled-item list-hours-item d-flex">
                            Tuesday
                            @if($store->tue_open == '00:00:00' && $store->tue_close == '00:00:00')
                                <span class="ml-auto">Closed</span>
                            @else
                        ...
                        <li class="list-unstyled-item list-hours-item d-flex">
                            Wednesday
                            @if($store->wed_open == '00:00:00' && $store->wed_close == '00:00:00')
                                <span class="ml-auto">Closed</span>
                            @else
                        ...
                        <li class="list-unstyled-item list-hours-item d-flex">
                            Thursday
                            @if($store->thu_open == '00:00:00' && $store->thu_close == '00:00:00')
                                <span class="ml-auto">Closed</span>
                            @else
                        ...
                        <li class="list-unstyled-item list-hours-item d-flex">
                            Friday
                            @if($store->fri_open == '00:00:00' && $store->fri_close == '00:00:00')
                                <span class="ml-auto">Closed</span>
                            @else
                        ...
                        <li class="list-unstyled-item list-hours-item d-flex">
                            Saturday
                            @if($store->sat_open == '00:00:00' && $store->sat_close == '00:00:00')
                                <span class="ml-auto">Closed</span>
                            @else
